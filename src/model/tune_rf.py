...
Evaluates every combination of max_depth, min_samples_leaf, and max_features
over the last TUNE_LAST_N_FOLDS walk-forward test years.

n_estimators is fixed at 200 for tuning speed — enough trees to rank configs
reliably. Production uses 500.

Run:
    python -m src.model.tune_rf
"""
...
from src.model.train_n_evaluate import (
    CAT_COLS,
    CFB_STAT_COLS,
